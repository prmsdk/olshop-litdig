  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">ANIEX OLSHOP</div>
      </a>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() . 'kategori/hotspot' ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() . 'kategori/alat_kecantikan' ?>">
          <i class="fas fa-fw fa-female"></i>
          <span>Alat Kecantikan</span></a>
      </li>
            ...
            <div class="navbar">
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <?php
                    ...
                    echo anchor('dashboard/detail_cart', $keranjang);
                  ?>
                </li>
              </ul>
              ...
              <ul class="nav navbar-nav navbar-right">
                <?php if($this->session->userdata('username')){ ?>
                  ...
                  <li><a class="ml-2" href="<?= base_url() . 'auth/logout'?>">Logout</a></li>
                <?php }else{ ?>
